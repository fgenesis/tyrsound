...
{
public:
	module_ext_impl( std::istream & stream, std::ostream & log, const std::map< std::string, std::string > & ctls ) : module_impl( stream, new std_ostream_log( log ), ctls ) {
		init();
	}
	module_ext_impl( const std::vector<char> & data, std::ostream & log, const std::map< std::string, std::string > & ctls ) : module_impl( data, new std_ostream_log( log ), ctls ) {
		init();
	}
	module_ext_impl( const char * data, std::size_t size, std::ostream & log, const std::map< std::string, std::string > & ctls ) : module_impl( data, size, new std_ostream_log( log ), ctls ) {
		init();
	}
	module_ext_impl( const void * data, std::size_t size, std::ostream & log, const std::map< std::string, std::string > & ctls ) : module_impl( data, size, new std_ostream_log( log ), ctls ) {
		init();
	}
